...
const experiences = [
    {
        ...
        img1 : <FaCheckCircle/>,
        point1: (<>Working as a Frontend Engineer on a large-scale e-commerce platform supporting <span className='text-base font-bold'>1000+ food delivery websites,</span> ensuring high availability and performance</>),
        img2 : <FaCheckCircle />,
        point2: "Developing and maintaining React.js-based UI components for online ordering, catering, and reservation workflows.",
        img3 : <FaCheckCircle />,
        point3: (<>Resolving production issues, UI defects, content updates, and payment-related configurations to ensure <span className='text-base font-bold'>uninterrupted service during high-traffic periods.</span></>),
        img4 : <FaCheckCircle />,
        point4: (<>Collaborating with cross-functional teams to ensure <span className='text-base font-bold'>application performance, stability, and smooth user experience.</span></>),
        delay: 0.3,
    },
    {
        ...
        img1 : <FaCheckCircle />,
        point1: (<>Supported and enhanced enterprise-level web applications using <span className='text-base font-bold'>JavaScript, React.js, HTML, and CSS.</span></>),
        img2 : <FaCheckCircle />,
    ...
    },
    {
        ...
        img1 : <FaCheckCircle />,
        point1: (<>Trained in frontend and backend fundamentals, including <span className='text-base font-bold'>JavaScript, React basics, REST APIs, and application workflows.</span></>),
        img2 : <FaCheckCircle />,
    ...
    },
    {
        ...
        img3 : <FaCheckCircle />,
        point3: (<>Built a strong foundation for transitioning into a <span className='text-base font-bold'>full-time frontend and full-stack development role.</span></>),
        img4 :  "",
        point4: "",
        delay: 0,
    },
